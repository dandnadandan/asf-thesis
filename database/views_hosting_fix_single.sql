-- =======================================================
-- HOSTING-COMPATIBLE VIEW - SINGLE VIEW AT A TIME
-- =======================================================
-- If you're getting errors, try running one view at a time
-- =======================================================

-- =======================================================
-- VIEW 1: vw_active_outbreaks
-- =======================================================

-- Drop first (run this even if you get an error)
...
-- =======================================================
-- VIEW 2: vw_high_risk_zones
-- =======================================================
-- Run this separately after the first view is created
